    ...
    void generatePeople(ActionEvent event) throws IOException {
    	try {
    		...
    		if(generator < 1) {
				...
				succesfullyAddedMsg.setHeaderText("EL N�MERO INGRESADO NO ES V�LIDO");
				succesfullyAddedMsg.setContentText("POR FAVOR INGRESE UN N�MERO MAYOR A 1.");
			...
			succesfullyAddedMsg.setTitle("NUMERO INVALIDO");
			succesfullyAddedMsg.setHeaderText("EL N�MERO INGRESADO NO ES V�LIDO");
			succesfullyAddedMsg.setContentText("POR FAVOR INGRESE UN N�MERO VALIDO.");
			succesfullyAddedMsg.showAndWait();
    	}
